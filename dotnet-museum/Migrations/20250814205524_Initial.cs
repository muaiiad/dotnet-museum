        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxNumberOfTickets = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artifacts_Galleries_GalleryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservationType = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    EventId = table.Column<int>(type: "int", nullable: false),
                    TourismCompanyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BookingId);
                    table.ForeignKey(
                        name: "FK_Bookings_Companies_TourismCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TourismCompanyId",
                table: "Bookings",
